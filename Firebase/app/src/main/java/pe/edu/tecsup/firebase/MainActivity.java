...
import pe.edu.tecsup.models.Post;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        User user2 = new User();
        user2.setUid(currentUser.getUid());
        user2.setDisplayName(currentUser.getDisplayName());
        user2.setEmail(currentUser.getEmail());
        user2.setPhotoUrl((currentUser.getPhotoUrl()!=null?currentUser.getPhotoUrl().toString():null));
        // user.setEtc...

        DatabaseReference usersRef = FirebaseDatabase.getInstance().getReference("users");
        usersRef.child(user2.getUid()).setValue(user2)
